...
try {
  ...
  `);
  db.close();
  console.log('✅ Cleared old mistake databases and migrated to node_id.');
} catch (e) {
  console.log('Failed to execute DB schema change. DB might be locked by server:', e.message);
}
