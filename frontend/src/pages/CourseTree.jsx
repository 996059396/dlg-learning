            ...
            return (
              <div
                ...
                style={{
                  ...
                  gap: 12,
                  padding: '14px 16px',
                  background: isMockExam ? '#EAF2FF' : isCompleted ? 'var(--tint-success-3)' : isUnlocked ? 'white' : '#F5F5F5',
              ...
              >
                <div style={{
                  ...
                  height: 40,
                  borderRadius: '50%',
                  background: isMockExam ? '#D8E8FF' : isCompleted ? 'var(--tint-success)' : isUnlocked ? 'var(--tint-orange)' : '#EEE',
                  display: 'flex',
                  alignItems: 'center',
