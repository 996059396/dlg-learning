...
// 1. Give every node a unique ID in the JSON curriculum
...
// 2. Clear corrupted Db
const dbPath = path.join(basePath, 'data', 'app.db');
const db = new Database(dbPath);

// Drop the old mistakes table and recreate with node_id TEXT
db.exec(`
...
`);
db.close();
console.log('✅ Cleared old mistake databases and migrated node_index to node_id.');
